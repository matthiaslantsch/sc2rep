...
class RankedFTWMiner {
	 ...
	 *
	 * @access public
	 * @param  teamUrl string | a get url parameter string with the mode and the players in it
	 * @param  timestamp integer | a timestamp for when the ranking is searched for
	 ...
	 *
	 * @access private
	 * @param  mode string | string for the gamemode (1v1, 2v2, usw...)
	 ...
	 *
	 * @access private
	 * @param  teamId integer | internal team_id in the rankedftw database
